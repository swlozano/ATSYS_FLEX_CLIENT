package COMMAND.CentroCosto
{
	...
	public class ModificarCentroCostoCommand implements ICommand, IResponder
	{
		[Bindable]
		...
		{
			new CentroCostoDelegate(this).modificarCentroCosto((event as CentroCostoEvent).centroCostoVo);
		}
