package COMMAND.Contratos
{
	...
	public class ModificarTerminacionContratoCommand implements ICommand, IResponder
	{
		...
		{
			new ContratoDelegate(this).modificarterminarContrato((event as ContratoEvent).terminarcontratoVO);
			//new ContratoDelegate(this).terminarContrato((event as ContratoEvent).terminarcontratoVO);
		}
