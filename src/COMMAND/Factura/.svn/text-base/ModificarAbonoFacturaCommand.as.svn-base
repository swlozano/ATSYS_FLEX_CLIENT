package COMMAND.Factura
{
	...
	public class ModificarAbonoFacturaCommand implements IResponder, ICommand
	{
		[Bindable]
		...
		{
			new FacturaDelegate(this).modificarAbonofactura((event as AbonoFacturaEvent).abonofacturaVo);
		}
