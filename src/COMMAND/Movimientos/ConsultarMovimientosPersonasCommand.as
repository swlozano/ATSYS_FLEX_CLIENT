package COMMAND.Movimientos
{
	...
	public class ConsultarMovimientosPersonasCommand implements IResponder, ICommand
	{
		...
		{
			new MovimientoDelegate(this).consultarMovimientosPersonas((event as ConsultasMovimientosEvent).ConsultasMovimientosVO);
		}
