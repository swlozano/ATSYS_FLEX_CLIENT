package COMMAND.Movimientos
{
	...
	public class ModificarMovimientosCommand implements IResponder, ICommand
	{
		...
		{
			new MovimientoDelegate(this).modificarMovimiento((event as MovimientoEvent).movimientoVO);
