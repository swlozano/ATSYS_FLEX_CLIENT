package COMMAND.RecursoHumano
{
	...
	public class AddRecursoHumanoCommand implements IResponder, ICommand
	{
		[Bindable]
		...
		{
			new RecursoHumanoDelegate(this).agregarRecursoHumano((event as RecursoHumanoEvent).recurso);
		}
