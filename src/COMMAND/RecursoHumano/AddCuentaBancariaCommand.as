package COMMAND.RecursoHumano
{
	...
	public class AddCuentaBancariaCommand implements ICommand, IResponder
	{
		...
		{
			new RecursoHumanoDelegate(this).agregarCuentaBancaria((event as RecursoHumanoEvent).cuenta);
		}
