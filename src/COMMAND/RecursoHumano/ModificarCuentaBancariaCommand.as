package COMMAND.RecursoHumano
{
	...
	public class ModificarCuentaBancariaCommand implements ICommand, IResponder
	{
		...
		{
			new RecursoHumanoDelegate(this).modificarCuentaBancaria((event as RecursoHumanoEvent).cuenta);
		}
