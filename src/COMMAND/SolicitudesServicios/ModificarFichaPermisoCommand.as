package COMMAND.SolicitudesServicios
{
	...
	public class ModificarFichaPermisoCommand implements IResponder, ICommand
	{
		...
		{
			new SolicitudesServiciosDelegate(this).modificarficha((event as SolicitudesServiciosEvent).fichasVo);
		}
