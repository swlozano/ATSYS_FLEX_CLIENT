  package COMMAND.usuarios
{
	...
	public class EliminarUsuariosSysCommand implements ICommand, IResponder
	{
		[Bindable]
		...
		{
			new UsuarioSysDelegate(this).eliminarUsuario();
		}
		...
		public function result(data:Object):void
		{
			if(data.result.idRespuesta==8){
			 ...
			 }else if(data.result.mensajeRespuesta=="No se eliminaron los datos. - El usuario tiene asignado roles."){
