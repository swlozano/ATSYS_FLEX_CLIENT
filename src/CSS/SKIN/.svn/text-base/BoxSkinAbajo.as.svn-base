package CSS.SKIN
{
	...
	CREATE CLASS
	----------------------------------------------------------------------------- */
	public class BoxSkinAbajo extends ProgrammaticSkin
	{		
		// PanelSkin constructor
		public function BoxSkinAbajo() {
			super();
 		}
		...
		override protected function updateDisplayList(unscaledWidth:Number,unscaledHeight:Number):void {
			...
			var titleWidth:Number = unscaledWidth;
			...
			// draw the rectangle
			g.drawRoundRectComplex(5,4,unscaledWidth-10,unscaledHeight,0,10,10,0);			
